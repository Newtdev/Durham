...
//   { section: "location", field_name: "projectCity0", field_value: "Colla" },
//   { section: "location", field_name: "projectState1", field_value: "Jezzi" },
//   { section: "location", field_name: "projectCity1", field_value: "Lafia" },
// ];

// const newArray = [];
// for (let i = 1; i <= locations.length; i++){
//   newArray.push({[`projectState${i}`], [`projectCity${i}`]})
// }
