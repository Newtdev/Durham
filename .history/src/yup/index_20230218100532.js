...
export const OwnerDesignConsultantLessSchema = Yup.object().shape({
  agreementDate: Yup.string().required("Field is required"),
  financialOfficerSignDate: Yup.string().required("Field is required"),
  sustainaibilityDate: Yup.string().required("Field is required"),
  notarizedDate: Yup.string().required("Field is required"),
  sexualOffenderOption: Yup.string().required("Field is required"),
});
