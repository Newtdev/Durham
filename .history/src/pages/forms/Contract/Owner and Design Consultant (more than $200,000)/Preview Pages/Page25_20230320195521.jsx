...
import { HandleTotal } from "../Component";
import Wrapper from "./Wrapper";

const OwnerDesignMore = (props) => {
  const designNarrativePhase = HandleTotal(
    props?.form_fields?.narrativePhase,
    props?.form_fields?.serviceCompensation
  );

  const schematicPhase = HandleTotal(
    props?.form_fields?.schematicPhase,
    props?.form_fields?.serviceCompensation
  );

  const developmentPhase = HandleTotal(
    props?.form_fields?.developmentPhase,
    props?.form_fields?.serviceCompensation
  );

  const negotiationsPhase = HandleTotal(
    props?.form_fields?.negotiationPhase,
    props?.form_fields?.serviceCompensation
  );
  const constructionContractPhase = HandleTotal(
    props?.form_fields?.constructionContractPhase,
    props?.form_fields?.serviceCompensation
  );
  const constructionPhase = HandleTotal(
    props?.form_fields?.constructionPhase,
    props?.form_fields?.serviceCompensation
  );
  const constructionServicePhase = HandleTotal(
    props?.form_fields?.constructionServicesPhase,
    props?.form_fields?.serviceCompensation
  );
        ...
        <div className="ml-[5rem] mr-[3rem]">
          <div className="grid grid-cols-2">
            ...
            <p className={`uj5 uj3 text-right `}>
              <span className={` ${props.nottoBeHighlighted}`}>
                ({currency(designNarrativePhase).format()})
              </span>
            </p>
          </div>
          <p class="uj2 uj48">
          ...
          <div className="grid grid-cols-2">
            ...
            <p className="uj5 uj3 text-right">
              {" "}
              <span className={` ${props.nottoBeHighlighted}`}>
                ({currency(schematicPhase).format()})
              </span>
            </p>
          </div>
          <p class="uj2 uj48">
          ...
          <div className="grid grid-cols-2">
            ...
            <p className="uj5 uj3 text-right">
              {" "}
              <span className={` ${props.nottoBeHighlighted}`}>
                ({currency(developmentPhase).format()})
              </span>
            </p>
          </div>
          <p class="uj2 uj48">
          ...
          <div className="grid grid-cols-2">
            ...
            <p className="uj5 uj3 text-right">
              {" "}
              <span className={` ${props.nottoBeHighlighted}`}>
                ({currency(negotiationsPhase).format()})
              </span>
            </p>
          </div>
          <p class="uj2 uj48">
          ...
          <div className="grid grid-cols-2">
            ...
            <p className="uj5 uj3 text-right">
              {" "}
              <span className={` ${props.nottoBeHighlighted}`}>
                ({currency(constructionPhase).format()})
              </span>
            </p>
          </div>
          <p class="uj2 uj48">
          ...
          <div className="grid grid-cols-2">
            ...
            <p className="uj5 uj3 text-right">
              {" "}
              <span className={` ${props.nottoBeHighlighted}`}>
                ({currency(constructionServicePhase).format()})
              </span>
            </p>
          </div>
        </div>
