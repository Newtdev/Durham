            ...
            <div className='relative w-[600px] bg-white rounded-lg shadow py-4'>
                ...
                <div className='mx-6 mb-12'>
                    ...
                    <div className=' mt-3 ml-2'>
                        ...
                        <div className='mb-4'>
                            <p className='text-gray-900 font-medium text-sm mb-[2px]'>
                                What percentage of the cost of the work that was added or removed serves as the base for fee adjustments?
                            </p>
                            <div className='relative w-full'>
                                <input
                                    {...percentage}
                            ...
                            {props.errors.percentage && props.touched.percentage && <Error message={props.errors.percentage} />}
                        </div>
                        <div className="w-full font-extrabold font-lg mb-4 pb-4 border-b"><h1 className="font-extrabold">Enter the daily amount that the CM is required to pay for liquidated damages.</h1></div>
                        ...
                        <div>
                            <div className='w-full flex items-center mb-5 mt-2 gap-x-3'>
                                <div className="w-full">
                                    ...
                                    {props.errors.substantialAmount && props.touched.substantialAmount && <Error message={props.errors.substantialAmount} />}
                                ...
                                <div className='flex flex-col w-full'>
                                    ...
                                    {props.errors.finalAmount && props.touched.finalAmount && <Error message={props.errors.finalAmount} />}
                        ...
                        <div className='flex flex-col mb-5'>
                            ...
                            <input
                                ...
                                className="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-sm hover:outline-[#3B6979] hover:border-[#3B6979] w-full p-2 flex items-center "
                            />
                            {props.errors.conferenceAddress && props.touched.conferenceAddress && <Error message={props.errors.conferenceAddress} />}
