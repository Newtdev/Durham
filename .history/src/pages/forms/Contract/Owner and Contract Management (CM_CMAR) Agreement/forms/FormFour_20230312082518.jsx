...
const FormFour = (props) => {
  ...
  const ocmCMContigency2 = {
    onChange: (e) => {
      if (isNaN(e.target.value)) {
        return "";
      } else {
        // return e.target.value
        props.setFieldValue("ocmCMContigency2", e.target.value);
      }
    },
    name: "ocmCMContigency2",
    error: props.errors.ocmCMContigency2,
    value: props.values.ocmCMContigency2,
    touched: props.touched.ocmCMContigency2,
    placeholder: "Amount",
    //    prevPage
  };
          ...
          <div className="mx-6 mb-12">
            <div className=" mt-3 ml-2">
              ...
              <div className="mb-6">
                ...
                {props.errors.ocmCMContigency2 &&
                  props.touched.ocmCMContigency2 && (
                    <Error message={props.errors.ocmCMContigency2} />
                  )}
              </div>
