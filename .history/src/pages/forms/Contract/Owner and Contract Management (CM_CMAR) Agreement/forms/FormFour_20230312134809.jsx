...
const FormFour = (props) => {
  ...
  const ownerContingencyocm = {
    onChange: (e) => {
      if (isNaN(e.target.value)) {
        return "";
      } else {
        // return e.target.value
        props.setFieldValue("ownerContingencyocm", e.target.value);
      }
    },
    name: "ownerContingencyocm",
    error: props.errors.ownerContingencyocm,
    value: props.values.ownerContingencyocm,
    touched: props.touched.ownerContingencyocm,
    placeholder: "Amount",
    //    prevPage
  };
          ...
          <div className="mx-6 mb-12">
            <div className=" mt-3 ml-2">
              ...
              <div className="mb-6">
                ...
                {props.errors.ownerContingencyocm &&
                  props.touched.ownerContingencyocm && (
                    <Error message={props.errors.ownerContingencyocm} />
                  )}
              </div>
