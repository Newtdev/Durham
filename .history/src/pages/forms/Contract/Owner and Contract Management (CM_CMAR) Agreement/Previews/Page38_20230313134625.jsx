      ...
      <div>
        ...
        <p class="fp f40">
          <span class="f0">
            ...
            completion of the work, the CM shall be liable for liquidated
            ...
            or its agent and in part by the CM or its contractors,
            ...
            foregoing provision making the CM liable for liquidated damages
            during a period of concurrent delay is found to be unenforcable,
            then the parties agree that in the event of a concurrent delay, the
            extent of the delay will be apportioned between the Owner and the
            CM, and the CM will be responsible for liquidated damages as set
            forth in the section 7.6 for those portions of the delay &nbsp;which
            are apportioned to the CM, its subconctractors, sub-subcontractors,
        ...
        <p class="fp f28">
          <span class="f0">
            ...
            result from the CM&rsquo;s default. &nbsp;If such legal or design
        ...
        <p class="fp f51">
          <span class="f0">
            ...
            Agreement.&nbsp; The amounts in this Agreement shall only be revised
            by written agreement between the parties.&nbsp; The monetary amounts
            follow:
          </span>
        </p>
        <div className="ml-12">
      ...
      <p class="fp f25">
        ...
        <p class="fp f2">
          <span class="f0">
            ...
            &ldquo;a&rdquo; or better by a.m. best company as will protect it,
            the Owner, the Design Consultant and their agents, representatives,
            and employees from claims as set forth below which may arise out of
            or result from the CM&rsquo;s operations under the Agreement,
            whether such
          </span>
        </p>
        <p class="fp f12 f4">
