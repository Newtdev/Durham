    ...
    <Wrapper>
      ...
      <p class="fp f2">
        <span class="f0">
          ...
          Consultant. &nbsp;All adjustments to the Master Schedule shall be made
      ...
      <p class="fp f2">
        <span class="f0">
          ...
          Paragraph 3.4.2.2 and that it establishes completion dates that comply
          with the requirements of the Master Schedule. &nbsp;The CM agrees that
          the construction schedule is for the benefit of the entire Project
          team and by execution of this Agreement gives permission and direction
          to its scheduler to provide copies of the schedule in a format as
