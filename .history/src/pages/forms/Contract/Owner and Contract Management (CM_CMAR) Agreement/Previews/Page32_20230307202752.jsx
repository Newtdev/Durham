    ...
    <Wrapper>
      ...
      <p class="fp f5" id="h.tyjcwt">
        <span class="f0">
          ...
          exceed the line item in the GMP for the cost of the work, then the CM
          shall have the right to terminate this Agreement.&nbsp; The CM shall
          provide the Owner with notice of intent to terminate pursuant to this
          provision within fifteen (15) days of the CM&rsquo;s receipt of bids
          for the Project.&nbsp; Prior to a termination pursuant to this
          provision becoming effective, the Owner and CM will review the list of
          alternates, other modifications or value engineering requests in order
          to determine whether an Agreement can be reached between the Owner and
          CM regarding a modified scope of work or an adjustment to the
          GMP.&nbsp; In the event an Agreement regarding the modified scope of
          the work and/or a revision to the GMP cannot be reached within fifteen
          (15) days of
        </span>
      </p>
      <p class="fp f38 f18">
