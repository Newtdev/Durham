...
// import AllPages from "./Preview Pages/AllPages";
    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          {/* Header */}
          <div
            className="flex justify-between items-baseline border-b border-b-gray-200 py-3 z-50"
          ...
          >
            ...
            <div>
              <ReactToPrint
                trigger={() => (
                  <button
                    className="border-4 border-gray-700 px-4 py-2 z-10"
                    style={{
                      position: "relative",
                      zIndex: 5,
                ...
                content={() => downloadComponent.current}
              />
              {/* <ComponentToPrint ref={componentRef} name="oderinde emmanuel" /> */}
              <DownloadPages ref={downloadComponent} />
            </div>
          </div>
