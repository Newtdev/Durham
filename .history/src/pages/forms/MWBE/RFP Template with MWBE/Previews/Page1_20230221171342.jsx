    ...
    >
      ...
      <p class="c3">
        ...
        <span className={` ${props?.nottoBeHighlighted}`}>
          {props?.form_fields?.prototypeNotUtilized} &nbsp;is preferred.
          &nbsp;Submission type, online or hard copy, will not affect proposal
          scoring. If submitting a hard copy, please submit 1 copy.
        </span>
        <span class="c24">&nbsp; </span>
      </p>
      <p class="c3 c12">
