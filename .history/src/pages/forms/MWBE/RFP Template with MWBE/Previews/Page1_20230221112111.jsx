...
const Page1 = (props) => {
  return (
    ...
    >
      <p class="c3 c311">
        <span
          class={`c81 c80 c148 c98 c96 border-b-2 border-black ${props?.nottoBeHighlighted}`}
        >
          Bidder: {props?.form_fields?.bidderName}______
        </span>
      </p>
      <p class="c129">
        ...
        <tr class="c306">
          <td class="c13" colspan="1" rowspan="1">
            ...
            <p class="c182">
              ...
              <span class={`c68 c89 ${props?.nottoBeHighlighted}`}>
          ...
          <td class="c118" colspan="1" rowspan="1">
            ...
            <p class="c182">
              ...
              <span class={`c89 c68 ${props?.nottoBeHighlighted}`}>
