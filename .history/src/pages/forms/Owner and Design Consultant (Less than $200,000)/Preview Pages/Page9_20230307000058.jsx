  ...
  return (
    <div style={{ margin: "1in", paddingTop: "6rem", height: "10in" }}>
      ...
      >
        ...
        <p className="text-right bg-transparent">
          <span
            class={`${props?.nottoBeHighlighted} `}
            style={{
              fontSize: "10pt",
        ...
        <p className=" text-right">
          <span class="p15 ">Project Manager</span>
        </p>
        <p className="text-right">
          <span class="p15 ">Durham Public Schools</span>
        </p>
        <p className="text-right">
          <span class="p15 ">Construction &amp; Capital Planning</span>
        </p>
      </div>
      <p class="p59 p12">
        <span class="p1"></span>
