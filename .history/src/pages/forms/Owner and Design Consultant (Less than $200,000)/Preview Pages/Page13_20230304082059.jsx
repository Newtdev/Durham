    ...
    <div style={{ margin: "1in", paddingTop: "6rem", height: "10in" }}>
      ...
      <p class="p9">
        <span class="p45 flex justify-between">
          <span
            class={`w-60 border-b border-b-black ${props?.nottoBeHighlighted}`}
            style={{ fontSize: "10pt", fontFamily: "Arial" }}
          >
            <span className="text-center w-full">{props?.awardee[0]?.title}</span><span style={{marginLeft: "auto"}}>(title)</span>
          </span>{" "}
          <span> ______________________ (date)</span>
        </span>
      </p>
      <p class="p9 p12">
        <span class="p7"></span>
