...
const Page9 = (props) => {
  ...
  return (
    <div style={{ margin: "1in", paddingTop: "6rem", height: "10in" }}>
      ...
      <div
        class="p11"
        className="w-60 border-4 border-[#c0c0c0] rounded-sm ml-4 leading-1"
      >
        <p>
          <span class="p15">Endorsement: </span>
        </p>
        <p className="text-right">
          <span
            class={`${props?.nottoBeHighlighted} mr-1`}
            style={{
              fontSize: "10pt",
              fontFamily: "Arial",
            }}
        ...
        <p className=" text-right">
          <span class="p15 mr-1">Project Manager</span>
        </p>
        <p className="text-right">
          <span class="p15 mr-1">Durham Public Schools</span>
        </p>
        <p className="text-right">
          <span class="p15 mr-1">Construction &amp; Capital Planning</span>
        </p>
      </div>
      <p class="p59 p12">
        <span class="p1"></span>
