    ...
    <div style={{ margin: "1in", paddingTop: "6rem", height: "10in" }}>
      ...
      <p class="p9">
        <span class="p45 flex justify-between">
          <span
            class={`w-60 border-b border-b-black  text-center ${props?.nottoBeHighlighted}`}
            style={{ fontSize: "10pt", fontFamily: "Arial" }}
          >
            <span className="">{props?.awardee[0]?.title}</span><span style={{marginLeft: "auto"}}>(title)</span>
          </span>{" "}
