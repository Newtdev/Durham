    ...
    <div style={{ margin: "1in", paddingTop: "6rem", height: "10in" }}>
      ...
      <div className="w-full text-[10pt] ml-2 pl-[1in] pr-4">
        ...
        <p className="flex justify-between">
          ...
          <span className="flex items-start w-48"><span className="mr-9">$</span>1,000,000.00</span>
        </p>
        <p className="flex justify-between">
        ...
        <p className="flex justify-between">
          <span>
          <span className="mr-2">c.</span> Utomobile Liability & Property Damage 
          </span>          <span className="flex items-start w-36">Combined Limit</span>
