...
const Page13 = (props) => {
  return (
    <div style={{ margin: "1in", paddingTop: "6rem", height: "10in" }}>
      ...
      <div>
        <div className="flex items-center">
          <input
            ...
            value="Initial"
            name="type"
            checked={props?.form_fields.type === "Initial" ? true : false}
            readOnly
        ...
        <div className="flex items-center">
          <input
            ...
            value="Supplimental"
            name="type"
            checked={props?.form_fields.type === "Supplemental" ? true : false}
            readOnly
            className="w-3 h-3 text-gray-600 bg-gray-100 border-gray-300"
          />
          <label for="default-radio-1" className="ml-2 text-gray-900 p7">
        ...
        <div className="flex items-center">
          <input
            ...
            value="Annual"
            name="type"
            checked={props?.form_fields.type === "Annual" ? true : false}
            className="w-3 h-3 text-gray-600 bg-gray-100 border-gray-300"
          />
          <label for="default-radio-1" className="ml-2  text-gray-900 p7">
            Annual
      ...
      <div
        className="h-[12rem] mb-6 flex items-end"
