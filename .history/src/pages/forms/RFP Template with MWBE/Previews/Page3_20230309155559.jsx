...
const Page3 = (props) => {
  return (
    <div
      ...
      className="border border-black flex flex-col justify-between h-full"
    >
      <>
        ...
        <p class="c27">
          <span class="c30">
            ...
            Public Schools response, and any additional terms deemed necessary
            by Durham Public Schools be posted in the form of an addendum to the
        ...
        <p class="c27">
          <span class="c30">
            Vendor contact regarding this RFP with anyone other than DPS
            employee listed above may be grounds for rejection of said
            Vendor&rsquo;s offer.
          </span>
        </p>
        <p class="c27">
          <span class="c30">
            Critical updated information may be included in these Addenda. It is
            important that all Vendors bidding on this RFP periodically check
            the State website for any and all Addenda that may be issued prior
            to the offer opening date.
          </span>
        </p>
        ...
        <p class="c27">
          <span class="c30">
            ...
            exhibits and attachments, and any other components made a part of
            this RFP, and comply with all requirements and specifications
            herein. &nbsp;Vendors also are responsible for obtaining and
            complying with all Addenda and other changes that may be issued in
        ...
        <p class="c27">
          <span class="c30 c80" style={{ fontSize: "10pt" }}>
            ...
            Section 1.1 PROPOSAL QUESTIONS. &nbsp;If Durham Public Schools
            determines that any changes will be made as a result of the
            questions asked, then such decisions will be communicated in the
            form of an RFP addendum. &nbsp;Durham Public Schools may also elect
            to leave open the possibility for later negotiation and amendment of
            specific provisions of the Contract that have been addressed during
            the question and answer period. &nbsp;Other than through this
            process, Durham Public Schools rejects and will not be required to
            evaluate or consider any additional or modified terms and conditions
            submitted with Vendor&rsquo;s proposal. &nbsp;This applies to any
            language appearing in or attached to the document as part of the
            Vendor&rsquo;s proposal that purports to vary any terms and
          ...
          <span class="c24" style={{ fontSize: "10pt" }}>
            By execution and delivery of this RFP Response, the Vendor agrees
            that any additional or modified terms and conditions, whether
            submitted purposely or inadvertently, shall have no force or effect,
            and will be disregarded. &nbsp;Noncompliance with, or any attempt to
            alter or delete, this paragraph shall constitute sufficient grounds
            to reject Vendor&rsquo;s proposal as nonresponsive.
          </span>
        </p>
        <p class="c27">
          <span class="c30">
            If a Vendor desires modification of the terms and conditions of this
            solicitation, it is urged and cautioned to inquire during the
            question period, in accordance with the instructions in this RFP,
            about whether specific language proposed as a modification is
            acceptable to or will be considered by Durham Public Schools.
            Identification of objections or exceptions to Durham Public
          </span>
        </p>
      </>
