    ...
    >
      <div style={{ lineHeight: "1.15" }}>
        ...
        <ul class="c14 list-disc">
          <li class="c201 c23 c106 flex ml-16">
          ...
          <li class="c340" style={{ lineHeight: "1.15" }}>
            <span class="c48">
              Copies of solicitations for quotes to at least three (3)
              MWBE&#39;s from the source list provided by the State for each
          ...
          <li class="c338 ">
            <span class="c48" style={{ lineHeight: "1.15" }}>
              Copies of quotes and responses received from each firm responding
              to the solicitation.
            </span>
          </li>
          <li class="c318 " style={{ lineHeight: "1.15" }}>
            <span class="c48">
        ...
        <ul class="c14 list-disc">
          <li class="c287 " style={{ lineHeight: "1.15" }}>
            <span class="c48">
