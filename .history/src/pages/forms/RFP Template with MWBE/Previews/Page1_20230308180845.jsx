    ...
    >
      <p class="c3 c311">
        <span class={`c81 c80 c148 c98 c96`}>
          Bidder:{" "}
          <span
            className={`border-b border-black ${props?.nottoBeHighlighted}`}
          >
      ...
      <p class="c3" style={{ fontSize: "10pt" }}>
        <span class="c98 c45">
      ...
      <p class="c8" style={{ fontSize: "10pt" }}>
        <span class="c98 c45">
      ...
      <p class={`c3 ${props?.nottoBeHighlighted}`} style={{ fontSize: "10pt" }}>
