...
const Page2 = (props) => {
  const [proposalScope, setProposalScope] = React.useState("");
  useEffect(() => {
    const proposal = props?.form_fields?.proposalScope;
    setProposalScope(props?.form_fields?.proposalScope);
    // const proposalScope = he.decode(props?.form_fields?.proposalScope);
    // console.log(proposalScope);
    // console.log(props.form_fields);
  }, [proposal]);
  console.log(proposalScope);
  console.log(
    "&lt;h2&gt;Does Attachment C(Pricing Form) needs to be included in Proposal&lt;/h2&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;"
  );
  // const proposalScope = he.decode(
  //   "&lt;h2&gt;Does Attachment C(Pricing Form) needs to be included in Proposal&lt;/h2&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;"
  // );
  // console.log(proposalScope);
  // const val = props?.form_fields?.proposalScope;
  // console.log("Page2");
  // console.log(val);
  // console.log(he.encode(val));

  // console.log(he.decode(props?.form_fields?.proposalScope));

  // const { proposalScope } = props?.form_fields;
  // console.log(proposalScope);
      ...
      <>
        ...
        <section
          dangerouslySetInnerHTML={{
            // __html: he.decode(props?.form_fields?.proposalScope),
            __html: he.decode(
              "&lt;h2&gt;Does Attachment C(Pricing Form) needs to be included in Proposal&lt;/h2&gt;&lt;p&gt;&lt;br&gt;&lt;/p&gt;"
            ),
          }}
