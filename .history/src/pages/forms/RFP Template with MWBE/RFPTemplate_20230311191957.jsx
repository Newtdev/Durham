...
const RFPTemplate = ({ id }) => {
  ...
  useEffect(() => {
    ...
    formik.setFieldValue("bidOpeningDate", a?.data?.form_fields.bidOpeningDate);
    formik.setFieldValue(
      "proposalSubmissionDate",
      a?.data?.form_fields.proposalSubmissionDate
    );
    formik.setFieldValue("proposalTime", a?.data?.form_fields.proposalTime);
    formik.setFieldValue("submissionTime", a?.data?.form_fields.submissionTime);
    formik.setFieldValue("answerTime", a?.data?.form_fields.answerTime);
    formik.setFieldValue("bidOpeningTime", a?.data?.form_fields.bidOpeningTime);
    formik.setFieldValue(
      "proposalSubmissionTime",
