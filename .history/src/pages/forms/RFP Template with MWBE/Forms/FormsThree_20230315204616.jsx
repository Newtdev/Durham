...
const FormThree = (props) => {
  ...
  const HandleSubmit = async (values) => {
    localStorage.setItem("attachFileYesOrNo", values.attachFileYesOrNo);
  ...
  let attachFileYesOrNo;
  useEffect(() => {
    attachFileYesOrNo = localStorage.getItem("attachFileYesOrNo");
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3 items-center">
                <input
                  ...
                  onChange={props.handleChange}
                  checked={attachFileYesOrNo === "Yes" ? true : false}
              ...
              <div className="flex gap-3 items-center">
                <input
                  ...
                  value="No"
                  name="attachFileYesOrNo"
                  checked={attachFileYesOrNo === "No" ? true : false}
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300"
                  onChange={props.handleChange}
                />
                <label
