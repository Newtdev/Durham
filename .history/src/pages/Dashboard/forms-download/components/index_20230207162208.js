    ...
    <article>
      ...
      <div className="relative w-full max-w-md h-screen md:h-auto mx-auto mt-14">
        ...
        <div className="relative bg-white rounded-lg shadow pb-4">
          ...
          <div className="mt-12 mr-5 gap-4 flex justify-center items-center w-full">
            <button className="bg-[#3B6979] text-white text-base w-24 py-2 px-8">
              BACK
            </button>
          </div>
          <div className="mt-8 mr-5 gap-4 flex justify-center items-center border-[#3B6979]">
