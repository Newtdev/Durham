    ...
    <article>
      ...
      <div className="relative w-full max-w-md h-screen md:h-auto mx-auto mt-14">
        ...
        <div className="relative bg-white rounded-lg shadow pb-4">
          ...
          <div className="mt-8 mr-5 gap-4 w-full">
            <button className="bg-[#3B6979] text-white text-base flex justify-center items-center">
              BACK
            </button>
          </div>
          <div className="mt-8 mr-5 gap-4 w-full">
            <button className="border border-[#3B6979] text-[#3B6979] text-base flex justify-center items-center">
              GO TO DASHBOARD
            </button>
          </div>
        </div>
