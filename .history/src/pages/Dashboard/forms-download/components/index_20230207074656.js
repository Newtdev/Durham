...
export function TableBody({ onDownload, skip, perPage, data }) {
  return (
    <table
    ...
    >
      <tbody className="text-base font-medium ">
        {data?.slice(skip, skip * perPage).map((manager, index) => {
...
export function Paginations(props) {
  ...
  return (
    ...
    >
      <Pagination count={5} onChange={handleChange} color="primary" />
    </nav>
  );
}
