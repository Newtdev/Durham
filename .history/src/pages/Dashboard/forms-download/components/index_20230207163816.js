...
export function SuccessModal({ close }) {
  return (
    <article>
      {/* Main modal */}
      <div className="relative w-full max-w-md h-screen md:h-auto mx-auto mt-14 pb-14">
        {/* Modal content */}
        <div className="relative bg-white rounded-lg shadow pb-4">
          ...
          <div className="mt-8 mr-5 flex justify-center items-center w-full">
            <button className="bg-[#3B6979] text-white text-base w-12">
              BACK
            </button>
          </div>
          <div className="mt-8 mr-5 flex justify-center items-center w-full">
            <button className="border border-[#3B6979] text-[#3B6979] text-base">
              GO TO DASHBOARD
            </button>
          </div>
        </div>
