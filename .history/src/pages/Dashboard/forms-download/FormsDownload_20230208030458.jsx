...
const FormsDownload = () => {
  ...
  const PER_PAGE = 6;
  const pages = Math.ceil(filteredFormsDownloadContent.length / 5);
        ...
        <div className="container mx-auto px-4 lg:px-24">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:justify-between md:items-center mt-4 mb-6">
            <div className="flex flex-col items-center justify-center gap-6">
              ...
              {/* <!-- Filter --> */}
              <Filter onChange={onChangeFilter} params={params} />
            </div>
            {/* <!-- Sort --> */}
            {/* <Sort/> */}
          ...
          {/* <!-- Table --> */}
          <div className="overflow-x-auto relative rounded-lg border-solid border border-gray-100 ">
