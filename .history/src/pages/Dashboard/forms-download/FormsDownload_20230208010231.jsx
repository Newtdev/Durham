...
const FormsDownload = () => {
  ...
  import { searchFormAction, filterFormAction } from "./formsSlice";

  const forms = useSelector((state) => state.form.filteredForm);
  ...
  const searchTermHandler = (e) => {
    ...
    // }
    dispatch(searchFormAction({ forms: formsDownloadContent, searchTerm: }));
  };
