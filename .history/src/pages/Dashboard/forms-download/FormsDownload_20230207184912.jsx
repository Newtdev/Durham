...
const FormsDownload = () => {
  ...
  let filteredFormsDownloadContent = formsDownloadContent;

  if (params === "all") {
    filteredFormsDownloadContent = formsDownloadContent;
  } else {
    filteredFormsDownloadContent = formsDownloadContent.filter(
