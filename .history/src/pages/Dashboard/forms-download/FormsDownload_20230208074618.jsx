...
import { FormsList } from "./formsDownloadComponents";
...
const FormsDownload = () => {
  ...
  const [filteredForms, setFilteredForms] = useState([...formsDownloadContent]);
  ...
  const filterHandler = (e) => {
    ...
    if (e.target.value === "all") {
      setFilteredForms(formsDownloadContent);
    }
  };
      ...
      <main className="pt-6 bg-[#fafafa] h-screen overflow-y-hidden">
        <div className="container mx-auto px-4 lg:px-24">
          <div className="flex gap-4 flex-col md:flex-row md:justify-between items-center">
            ...
            <a
              href="https://durhamapp.000webhostapp.com/pdfs/All Forms.zip"
              download
            >
              <DashboardButton
                onClick={() => {
