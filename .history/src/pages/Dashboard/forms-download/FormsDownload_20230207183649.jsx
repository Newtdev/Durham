...
const FormsDownload = () => {
  ...
  const filteredFormsDownloadContent = formsDownloadContent.filter(
    (form) => formsDownloadContent.organisation === params
  );

  const FormsDownloadProps = {
    dataArray: filteredFormsDownloadContent || formsDownloadContent,
    pages,
    perPage: PER_PAGE,
    skip,
  };
