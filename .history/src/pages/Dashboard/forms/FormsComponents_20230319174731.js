      ...
      {dataArray.slice(skip, skip + perPage).map((manager, index) => {
        ...
        return (
          ...
          >
            <li
              // scope="row"
              className="py-4 px-2 font-normal capitalize text-gray-900 whitespace-nowrap w-[60%] flex items-center justify-start gap-3"
            >
            ...
            <li
              // scope="row"
              className="md:py-4 md:px-4 pl-32 font-normal capitalize text-[#693B79] whitespace-nowrap w-[25%] lg:text-center md:text-right"
            >
              {category}
            </li>
