...
export const Vendor3Bid = Yup.object().shape({
  ...
  services: Yup.string().required("Descriptions field is required"),
  ...
  projectZipCode: Yup.string().required("Zip Code field is required"),
  totalPrice: Yup.string().required("Price field is required"),
  unitPrice: Yup.string().required("Price field is required"),
