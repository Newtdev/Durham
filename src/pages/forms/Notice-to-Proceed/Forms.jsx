                    ...
                    <div className=' mt-3 ml-2'>
                        ...
                        <FormInputContainer name='What time and date does the project go into effect?'>
                            ...
                            <div className='flex justify-between'>
                                {props.errors.startDate && props.touched.startDate && <Error message={props.errors.startDate}/>} {props.errors.startTime && props.touched.startTime && <Error message={props.errors.startTime}/>}
