...
//               <div className='px-6 pt-8 pb-4 text-black'>
//                 <div>
//                   <div className='border-b border-b-black pb-4 flex items-center mb-3'>
//                     <div className='pr-4'>Logo</div>
//                     <div className='pl-4 border-l border-l-black'>
//                       <h1 className='text-xl font-bold'>E-589CI</h1>
...
//                       used to substantiate that a contract, or a portion of work
//                       to be performed to fulfill a contract, is to be taxed for
//                       sales and use tax purposes, as a real property contract
//                       for a capital improvement to real property.
//                     </p>
...
//                       person receiving the affidavit should treat the
//                       transaction as a real property contract for sales and use
//                       tax purposes.
//                     </p>

//                     <p>
//                       A real property contract is a contract between a real
//                       property contractor and another person to perform a
...
//                       <em>
//                         Complete this section to issue the affidavit for a
//                         single capital improvement.)
//                       </em>
//                     </p>
...
//                             </p>
//                             <p className='bg-blue-100 p-1'>F1</p>
//                           </div>
//                           <div className='mb-1'>
//                             <p className='text-xs font-bold'>Address</p>
//                             <p className='bg-blue-100 p-1'>F2</p>
//                           </div>
//                           <div className='flex justify-between mb-1'>
//                             <div className='w-[58%]'>
//                               <p className='text-xs font-bold'>City</p>
//                               <p className='bg-blue-100 p-1 h-[32px]'></p>
//                             </div>
//                             <div className='w-[10%]'>
...
//                                 <em className='font-normal text-xs'>
...
//                               </p>
//                             </div>
//                             <p className='bg-blue-100 p-1'>F3</p>
//                           </div>
//                           <div className='mb-1'>
//                             <p className='text-xs font-bold'>Address</p>
//                             <p className='bg-blue-100 p-1'>F4</p>
//                           </div>
//                           <div className='flex justify-between mb-1'>
//                             <div className='w-[58%]'>
//                               <p className='text-xs font-bold'>City</p>
...
//                       <div className='mb-3'>
//                         <p className='text-xs font-bold'>
//                           Describe capital im[rovement to be performed:
//                         </p>
//                         <div className='h-32 bg-blue-100 p-1'>F5</div>
//                       </div>

//                       <div className='mb-3'>
//                         <p className='text-xs font-bold'>Project Name</p>
//                         <div className='bg-blue-100 p-1'>F6</div>
//                       </div>
...
//                             </span>
//                           </p>
//                           <p className='bg-blue-100 p-1'>F7</p>
//                         </div>
//                         <div className='w-[25%]'>
//                           <p className='text-xs font-bold'>City</p>
//                           <p className='bg-blue-100 p-1 h-[32px]'></p>
...
//                           Property Contractor (General Contractor or
//                           Subcontractor identified in box “B”) shall be treated
//                           as a real property contract for a capital improvement
//                           to real property for sales and use tax purposes. I
...
//                         </span>
//                         <em>
//                           Complete this section to execute a blanket affidavit
...
//                                 Real Property Contractor
//                               </p>
//                               <p className='bg-blue-100 p-1'>F8</p>
//                             </div>
//                             <div className='mb-1'>
//                               <p className='text-xs font-bold'>Address</p>
//                               <p className='bg-blue-100 p-1'>F9</p>
//                             </div>
//                             <div className='flex justify-between mb-1'>
//                               <div className='w-[58%]'>
//                                 <p className='text-xs font-bold'>City</p>
...
//                                 </p>
//                               </div>
//                               <p className='bg-blue-100 p-1'>F10</p>
//                             </div>
//                             <div className='mb-1'>
//                               <p className='text-xs font-bold'>Address</p>
//                               <p className='bg-blue-100 p-1'>F11</p>
//                             </div>
//                             <div className='flex justify-between mb-1'>
//                               <div className='w-[58%]'>
//                                 <p className='text-xs font-bold'>City</p>
...
//                             performs capital improvements to real property and
//                             all transactions with the real property contractor
//                             (subcontractor) identified in box “D” shall be
//                             treated as real property contracts for capital
//                             improvements to real property for sales and use tax
//                             purposes. I understand that if it is determined that
//                             I issued this affidavit in error and the transaction
//                             is subject to sales tax as a retail sale of repair,
//                             maintenance, and installation services to real
//                             property, I will be liable for payment of any
...
//                       Form E-589CI, Affidavit of Capital Improvement, may be
//                       issued to substantiate that a contract, or a portion of
//                       work performed to fulfill a contract, is a capital
//                       improvement to real property and subject to sales and use
//                       tax as a real property contract. Generally, services to
//                       real property are retail sales of or the gross receipts
//                       derived from repair, maintenance, and installation
//                       services, unless a person substantiates that a transaction
//                       is subject to tax as a real property contract, subject to
//                       tax as a mixed transaction contract, or the transaction is
//                       not subject to sales and use tax. A “real property
//                       contract” is a contract between a real property contractor
//                       and another person to perform a capital improvement to
//                       real property.{" "}
//                     </p>

//                     <p className='text-justify mb-4'>
//                       A mixed transaction contract is a contract that includes
//                       both a real property contract for a capital improvement
//                       and repair, maintenance, and installation services for
//                       real property that are not related to the capital
//                       improvement. For a mixed transaction contract, if the
//                       allocated sales price of the taxable repair, maintenance,
//                       and installation services included in the contract{" "}
...
//                           not a capital improvement, but rather the transaction
...
//                         <p>•</p>
//                         <p className='ml-4'>
//                           A person who receives Form E-589CI from another
//                           person, absent fraud or other egregious activities, is
//                           not liable for any additional tax on the gross
//                           receipts from the transaction if it is determined that
//                           the transaction is not a capital improvement.
//                         </p>
//                       </div>
//                       <div className='flex'>
//                         <p>•</p>
...
//                           personal property, or digital property exempt from
//                           sales and use tax.
//                         </p>
//                       </div>
//                     </div>
...
//                         Exceptions from the Issuance of Form E-589CI to
//                         Establish a Transaction is to be Taxed as a Real
//                         Property Contract
//                       </strong>{" "}
//                       <br /> In lieu of issuing an affidavit of capital
//                       improvement, a person may substantiate by other records
//                       that a transaction is a real property contract or a mixed
...
//                       </strong>{" "}
//                       <br /> A person may complete “Section I - Single Use” for
//                       a one time use to substantiate that a transaction is a
//                       real property contract for a single capital improvement to
//                       real property and subject to sales and use tax as a real
//                       property contract. When a real property contractor hires a
...
//                       more than twelve months elapse between transactions
//                       between two parties), “Section I – Single Use” may be
//                       completed and the form issued to the subcontractor as
//                       notice that the transaction is subject to sales and use
//                       tax as a real property contract.
//                     </p>

//                     <p className='text-justify mb-4'>
//                       The following scenarios are for reference to assist a
//                       person to complete and issue Form E-589CI. The scenarios
//                       presented are not intended to cover all possible uses of
//                       the form.
//                     </p>

//                     <p className='text-justify mb-4'>
//                       A <span className='underline'>property owner</span>{" "}
//                       oversees the entire activity to real property that is a
//                       real property contract for a capital improvement to real
//                       property. The property owner hires various{" "}
//                       <span className='underline'>subcontractors</span>
//                       to complete the real property contract or portions
//                       thereof:
//                     </p>
...
//                         <p>•</p>
//                         <p className='ml-4'>
//                           Owner listed in Box A must enter the project address
//                           (if different than the address entered in Box A).
//                         </p>
//                       </div>
//                       <div className='flex'>
//                         <p>•</p>
...
//                           enters the date, and issues to the person listed in
//                           Box B.
//                         </p>
//                       </div>
//                     </div>
...
//                       oversee the entire activity to real property that is a
//                       real property contract for a capital improvement to real
//                       property. The general contractor hires a{" "}
//                       <span className='underline'>subcontractor</span> to
//                       perform the real property contract, or portion thereof:
//                     </p>
...
//                           title (general contractor), enters the date, and
...
//                       the installation of equipment that is to be attached to
//                       real property and will be depreciated under the Internal
//                       Revenue Code:
//                     </p>
...
//                           equipment will be depreciated under the Internal
//                           Revenue Code.
//                         </p>
//                       </div>
//                       <div className='flex'>
...
//                       business relationship or until the affidavit is withdrawn
//                       or otherwise notified by the issuer of the form.
//                     </p>

//                     <p className='text-justify mb-4'>
//                       The blanket use will generally apply for the following:
//                       (1) a builder who hires the same contractor(s) only for
//                       new construction; (2) a real property contractor who hires
//                       the same subcontractor(s) only for reconstruction; (3) a
//                       real property contractor who hires the same
//                       subcontractor(s) for remodeling or renovation and the
//                       activities performed by the subcontractor(s) for the other
//                       party are never repair, maintenance, and installation
//                       services for real property based on the contract or
//                       agreement between the parties; and (4) a real property
//                       contractor who exclusively hires the same subcontractor(s)
//                       to perform part, or all, of its real property contracts
//                       for capital improvements to real properties.
//                     </p>
...
//                         <p>•</p>
//                         <p className='ml-4'>
//                           <strong>Box C - Real Property Contractor:</strong>{" "}
//                           Enter the hiring real property contractor’s name and
//                           address.
//                         </p>
//                       </div>
//                       <div className='flex'>
...
export const DataListComponent = ({
	...
	<FormInputContainer name={name}>
		...
		/>
		<datalist id={inputname}>{fn()}</datalist>
	</FormInputContainer>
);
