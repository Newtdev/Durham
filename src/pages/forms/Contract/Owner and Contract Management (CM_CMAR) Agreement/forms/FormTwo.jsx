                        ...
                        render={(arrayHelpers) => (
                            <>
                                <div className='flex flex-col mb-5'>
                                    ...
                                    />
                                    {props.errors.projectName && props.touched.projectName && <Error message={props.errors.projectName} />}
                                            ...
                                            <div>
                                                ...
                                                <div className='grid grid-cols-3 gap-x-4'>
                                                    <FormInputContainer name=''>
                                                        <FormSelect
                                                            value={props.values.location[index].projectState} name=''
                                                        ...
                                                        {props.errors.projectState && props.touched.projectState && <Error message={props.errors.projectState} />}
                                                    </FormInputContainer>

                                                    <FormInputContainer name=''>
                                                        <FormSelect value={props.values.location[index].projectCity} name=''
                                                        ...
                                                        {props.errors.projectCity && props.touched.projectCity && <Error message={props.errors.projectCity} />}
                                                    </FormInputContainer>

                                                    <FormInputContainer name=''>
                                                        <FormSelect value={props.values.location[index].projectZipCode} name=''
                                                        ...
                                                        {props.errors.projectZipCode && props.touched.projectZipCode && <Error message={props.errors.projectZipCode} />}
                                                    </FormInputContainer>
