					...
					<div>
						<div className="flex gap-8 mb-2">
							...
							<p className="text-justify">
								<span className="mr-3">WORK:</span> The Design Consultant shall
								perform the services outlined on the attached Exhibit A. Exhibit
								A shall contain the scope of work and the authorized services.
							</p>
						</div>
						...
						<div className="flex gap-8 mb-2">
							<p>1.2</p>
							<p className="text-justify">
								<span className="mr-3">TIME:</span> The work outlined in Exhibit
								A shall be completed in accordance with the schedule included in
								Exhibit A. In the event that circumstances beyond the Design
								Consultant’s control force a delay that prohibits or may
								prohibit the Design Consultant’s compliance with the schedule,
								the Design Consultant shall inform the Owner immediately.
							</p>
						</div>
						...
						<div className="flex gap-8 mb-2">
							...
							<p className="text-justify">
								...
								Paragraph. Exhibit A shall specify the hourly rate schedule for
								any services that may be utilized under this Agreement. The
								Design Consultant shall not be compensated for any work or
						...
						<div className="flex gap-8 mb-2">
							...
							<div>
								...
								<p className="mb-1 text-justify">
									...
									Design Consultant's employees or any other person; claims for
									...
									negligent acts, errors or omissions for which the Design
									Consultant is legally liable. Minimum limits of coverage shall
									be:
								</p>
