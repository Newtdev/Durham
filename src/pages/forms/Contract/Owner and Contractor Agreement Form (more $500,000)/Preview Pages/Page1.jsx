	...
	return (
		<div className=" pb-4 text-black font11  text-[11pt] leading-[1.3] h-[11in] ">
			<div>
				...
				<div className=" h-[10.5in] mt-[1in] ml-[1in] mr-[1in] mb-[0.1in] flex flex-col justify-between overflow-y-hidden bg-red-400">
					<div className="">
						...
						<p className="mb-4 text-justify">
							...
							under this Contract shall be sent in writing to the above
							addresses; unless either party is notified in writing by the
							other, of a change in address.
						</p>
						...
						<p className="mb-4 text-justify">
							...
							the promises made herein and other good and valuable
							...
							<div>
								...
								<div className="flex gap-8">
									...
									<p className="text-justify">
										...
										Specifications, all Addenda issued prior to bidding, and all
										Modifications and Change Orders issued after execution of
										the Contract.
									</p>
								</div>
							</div>
