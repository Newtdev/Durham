		...
		<PageWrapper num={1}>
			<div>
				...
				<p className="mb-4 text-justify">
					...
					. (herein referred {"  "} to {"  "}as the "Contractor"), whose mailing
					address is{" "}
					{vendor[0] ? (
						<span className={`${nottoBeHighlighted} border-b border-black`}>
				...
				<p className="mb-4 text-justify">
					<span className="ml-12">WHEREAS,</span> it is the intent of the Owner
				...
				<p className="mb-4 text-justify">
					...
					perform such construction in accordance with the terms and conditions
					of this Agreement,
				</p>
				<p className="mb-4 text-justify">
					<span className="ml-12">NOW, THEREFORE,</span> in consideration of the
					promises made herein and other good and valuable consideration, the
					following terms and conditions are hereby mutually agreed to, by and
					...
					<div>
						<div className="flex gap-8 mb-4">
							...
							<p className="text-justify">
								All terms in this Agreement which are defined in the Information
								for Bidders and the General Conditions shall have the meanings
								designated therein.
							</p>
						</div>
						<div className="flex gap-8">
							<p>1.2</p>
							<p className="text-justify">
								The Contract Documents are as defined in the General Conditions.
								Such documents form the Contract, and all are as fully a part
								thereof as if attached to this Agreement or repeated herein. The
								Contract Documents consist of the Owner-Contractor Agreement,
								the General and Supplemental Conditions of the Contract, the
								Drawings, the Specifications, all Addenda issued prior to
								bidding, and all Modifications and Change Orders issued after
