...
const PageOne = ({
	...
	return (
		<div className=" pb-4 text-black font11  text-[11pt] leading-[1.3] h-[11in] ">
			<div>
				{/* Page 1 */}
				<div className="mt-[1in] ml-[1in] mr-[1in] mb-[0.1in] flex flex-col justify-between bg-green-500">
					...
					<p className="mb-4 text-justify">
						<span className="ml-12">THIS AGREEMENT,</span> in four (4) copies,
						made this{" "}
						<span
						...
						. Correspondence, submittals, and notices relating to or required
						under this Contract shall be sent in writing to the above addresses;
						unless either party is notified in writing by the other, of a change
						in address.
					</p>
					...
					<p className="mb-4 text-justify">
						...
						Owner to obtain the services of the Contractor in connection with
					...
					<p className="mb-4 text-justify">
						<span className="ml-12">WHEREAS,</span> the Contractor desires to
						perform such construction in accordance with the terms and
						conditions of this Agreement,
					</p>
					<p className="mb-4 text-justify">
						<span className="ml-12">NOW, THEREFORE,</span> in consideration of
						the promises made herein and other good and valuable consideration,
						the following terms and conditions are hereby mutually agreed to, by
						and between the Owner and Contractor:
					</p>
						...
						<div>
							<div className="flex gap-8 mb-4">
								...
								<p className="text-justify">
									...
									Information for Bidders and the General Conditions shall have
							...
							<div className="flex gap-8">
								...
								<p className="text-justify">
									...
									Conditions. Such documents form the Contract, and all are as
									fully a part thereof as if attached to this Agreement or
									repeated herein. The Contract Documents consist of the
									Owner-Contractor Agreement, the General and Supplemental
									Conditions of the Contract, the Drawings, the Specifications,
									all Addenda issued prior to bidding, and all Modifications and
									Change Orders issued after execution of the Contract.
								</p>
							</div>
						</div>
					</div>
							...
							<div className="flex gap-8 mb-4">
								...
								<div>
									<p className="text-justify mb-4">
										...
										<span
											className={`${nottoBeHighlighted} border-b border-black`}>
											Durham Public Schools 511 Cleveland Street, Durham, NC
											27702
										</span>
					...
					<div className="flex justify-between mt-8 text-[8pt]">
