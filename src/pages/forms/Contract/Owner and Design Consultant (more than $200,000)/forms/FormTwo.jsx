					...
					<div className="mx-6 mb-12">
						<div className="mt-3 ml-2 flex flex-col gap-3 ">
							<FormInputContainer name="Completion of schematic design">
								...
								{props.errors.schematicCompletionDate &&
									props.touched.schematicCompletionDate && (
										<Error message={props.errors.schematicCompletionDate} />
									)}
							</FormInputContainer>

							<FormInputContainer name="Completion of construction documents">
								<SelectDate {...constructionCompletionDate} />
								{props.errors.constructionCompletionDate &&
									props.touched.constructionCompletionDate && (
										<Error message={props.errors.constructionCompletionDate} />
									)}
							</FormInputContainer>

							<FormInputContainer name="Notice to Proceed date">
								<SelectDate {...noticeDate} />
								{props.errors.noticeDate && props.touched.noticeDate && (
									<Error message={props.errors.noticeDate} />
								)}
							</FormInputContainer>
