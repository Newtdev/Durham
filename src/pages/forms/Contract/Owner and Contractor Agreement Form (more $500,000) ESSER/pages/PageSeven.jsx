...
const PageSeven = ({ formDetails, durham, nottoBeHighlighted, vendor }) => {
	return (
		<div className=" pt-6 pb-4 text-black  text-[11pt] leading-[1.3] h-[11in]">
			<div>
				{/* Page 7 */}
				<div className="mx-[1in] mt-[0.5in]">
					<div className="flex gap-8">
						...
						<div>
							...
							<p className="text-justify">
								...
								shall not use covered telecommunications equipment or services
								as a substantial or essential component of a system or as part
								of any system.
							</p>
						</div>
					</div>
					...
					<div className="flex gap-8">
						...
						<div>
							...
							<p className="text-justify">
								...
								reports or quarterly or annual financial reports, as applicable,
					...
					<div className="flex gap-8 mb-10">
						...
						<div>
							...
							<p className="text-justify">
								...
								of his/her/its principle and further acknowledges the execution
					...
					<div>
						...
						<div className="flex justify-between mt-48 pt-4">
