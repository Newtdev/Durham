...
const PageTwo = ({ formDetails, vendors, nottoBeHighlighted }) => {
	...
	return (
		<div className=" pt-8 pb-4 text-black text-[11pt] h-[11in]  leading-[1.3]">
			<div>
				{/* Page 2 */}
				<div className="m-[1in]">
					...
					<div>
						...
						<div className="flex gap-8 mb-4">
							...
							<div>
								...
								<p className="ml-[22px]">
									<span className={`${nottoBeHighlighted}`}>
										{currency(formDetails?.allowances).format()}
									</span>
								</p>
							</div>
						</div>
						<div className="flex gap-8 mb-4">
							...
							<p className="text-justify">
								...
								necessary, to fully and properly perform and complete the Work,
						...
						<div className="flex gap-8 mb-4">
							...
							<p className="text-justify">
								...
								Documents not to be the obligation of the Contractor. The
								totality of the obligations imposed upon the contractor by this
								Article and by all other provisions of the Contract Documents,
								as well as the structures to be built and the labor to be
								performed, is herein referred to as the "Work".
							</p>
						</div>
					</div>
						...
						<div>
							<div className="flex gap-8 mb-4">
								...
								<p className="text-justify">
									...
									Contractor, unilaterally amend this Article from time to time
									by designating a different person or organization to act as
									its Design Consultant and so advising the Contractor in
									writing, at which time the person or organization so
									designated shall be the Design Consultant for purposes of this
									Contract.
								</p>
							</div>
						</div>
					...
					<div className="flex justify-between mt-20 pt-2">
						<p className="text-[8pt]">Section C, Owner-Contractor Agreement</p>
						<p className="text-[8pt]">C-2</p>
					</div>
				</div>
			</div>
		</div>
