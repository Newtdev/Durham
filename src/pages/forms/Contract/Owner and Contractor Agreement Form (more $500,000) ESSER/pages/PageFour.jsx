			...
			<div>
				<div className="flex gap-8 mb-3">
					...
					<p className="text-justify">
						...
						deliver to the Owner's Project Manager an Application for Payment in
						accordance with the provisions of Article 9 of the General
						...
						Payments due and unpaid under the Contract Documents shall not bear
						interest.
					</p>
				</div>
					...
					<div>
						<div className="flex gap-8 mb-4">
							...
							<p className="text-justify">
								...
								Material Payment Bond and Certification of Insurance as required
						...
						<div className="flex gap-8 mb-4">
							...
							<p className="text-justify">
								...
								Stat. 143-128.2, and as described in the construction documents.
							</p>
						</div>
						<div className="flex gap-8 mb-4">
							<p>7.4</p>
				...
				<div>
					<div className="mb-4">
						...
						<p className="text-justify">
							The Contractor is notified that this project will be financed with
							federal funds. The Contractor shall ensure that all subcontracts
							and other contracts for goods and services for this project have
							the below provisions of this section their contracts. Contractor
							agrees to comply with the following provisions. Failure to comply
							with any and all provisions herein may be cause for the Owner to
							issue a cancellation notice to the Contractor. In the event of a
							conflict between this section and any other provision in this
							Agreement, the parties agree that this section shall prevail.
						</p>
					</div>
					...
					<div className="flex gap-8">
						...
						<div>
							...
							<p className="text-justify">
								...
								applicable laws and regulations with respect to this Agreement
					...
					<div className="flex gap-8">
						...
						<div>
							...
							<p className="text-justify">
								...
								Agreement in the event of a breach or default of the agreement
								by Contractor, in the event Contractor fails to: (1) meet
