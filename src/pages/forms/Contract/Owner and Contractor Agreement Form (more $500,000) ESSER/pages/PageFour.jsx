					...
					<div>
						<div className="mb-4">
							...
							<p className="text-justify">
								...
								subcontracts and other contracts for goods and services for this
								project have the below provisions of this section their
								contracts. Contractor agrees to comply with the following
								provisions. Failure to comply with any and all provisions herein
								may be cause for the Owner to issue a cancellation notice to the
								Contractor. In the event of a conflict between this section and
						...
						<div className="flex gap-8">
							...
							<div>
								...
								<p className="text-justify">
									...
									Agreement and/or the IPPA. The Owner also reserves the right
									to terminate the Agreement immediately, with written notice
								</p>
							</div>
						</div>
					</div>

					<div className="flex justify-between mt-24 pt-2">
