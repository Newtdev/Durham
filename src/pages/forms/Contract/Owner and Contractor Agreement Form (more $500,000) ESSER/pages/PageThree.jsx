...
export const Total = (a) => {
	return useMemo(() => {
		...
		for (const object of a) {
			quantitySum += Number(object.modificationAmount);
		}
		return currency(quantitySum).format();
	}, [a]);
};
							...
							<div>
								...
								<div className="flex gap-8 mb-3">
									...
									<p className="text-justify">
										The Contractor shall commence the Work promptly upon the
										date established in the Notice to Proceed. If there is no
										Notice to Proceed, the date of commencement of the Work
										shall be the date of this Agreement or such other date as
										may be established herein.
									</p>
								</div>
								<div className="flex gap-8 mb-3">
									<p>4.2</p>
									<p className="text-justify">
										...
										. The Contractor shall achieve Final Completion, as defined
										in the General Conditions on or before{" "}
										<span className={`${nottoBeHighlighted}`}>
								...
								<div className="flex gap-8 mb-3">
									...
									<p className="text-justify">
										...
										otherwise stipulated. The only exceptions to this schedule
										are defined in the General Conditions under 8.3 DELAYS AND
										EXTENSIONS OF TIME.
									</p>
								</div>
								<div className="flex gap-8 mb-3">
									...
									<p className="text-justify">
										...
										Completion, or such later date as may result from an
										extension of time granted by the Owner, he shall pay the
										Owner, as liquidated damages the sums set forth in the
							...
							<div>
								<div className="flex gap-8 mb-3">
									...
									<p className="text-justify">
										...
										Owner shall pay to the Contractor, in current funds and at
										the time and in the installments hereinafter specified, the
										sum of{" "}
										<span className={`${nottoBeHighlighted}`}>
										...
										herein referred to as the "Contract Sum". This amount
										includes the base bid and the Alternates in Section 2.2
									</p>
								</div>
								<div className="flex gap-8 mb-3">
									<p>5.2</p>
										...
										<table className="border border-black w-[550px] mb-4">
											<tbody>
												...
												<tr className="border border-black border-collapse">
													...
													<td
														className={`${nottoBeHighlighted} text-right px-3`}>
