			...
			<div>
				...
				<div className="mx-[1in] mt-[0.5in] ">
					<p className="text-justify ml-[58px]">
						...
						purchase goods and services from other vendors when it is in the
					...
					<div className="flex gap-8">
						...
						<div>
							...
							<p className="text-justify">
								...
								pursuant to this Agreement, the Contractor certifies it will be
								in compliance with all applicable Davis-Bacon Act provisions. In
								...
								violations to the Federal awarding agency. Contractor certifies
								it will comply with the Copeland “Anti-Kickback” Act (40 U.S.C.
								3145), as supplemented by Department of Labor regulations (29
								CFR Part 3, “Contractors and Subcontractors on Public Building
								or Public Work Financed in Whole or in Part by Loans or Grants
								from the United States”). The Act provides that each vendor or
								...
								or she is otherwise entitled. The Owner will report all
					...
					<div className="flex gap-8">
						...
						<div>
							...
							<p className="text-justify">
								...
								of mechanics or laborers, the Contractor will be in compliance
								with all applicable provisions of the Contract Work Hours and
								Safety Standards Act. Under 40 U.S.C. 3702 of the Act, each
								vendor must be required to compute the wages of every mechanic
								...
								that the worker is compensated at a rate of not less than one
								and a half times the basic rate of pay for all hours worked in
								excess of 40 hours in the work week. The requirements of 40
								U.S.C. 3704 are applicable to construction work and provide that
								no laborer or mechanic must be required to work in surroundings
