              ...
              <div className='mb-4'>
                ...
                <FormInputContainer name="What's the duration of the agreement?">
                  ...
                  <div className='flex justify-between'>
                    {props.errors.startDate && props.touched.startDate && <Error message={props.errors.startDate} />} {props.errors.endDate && props.touched.endDate && <Error message={props.errors.endDate} />}
