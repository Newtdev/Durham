...
const Quixote = (props) => (
    ...
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.title}>TECHNOLOGY SERVICES AGREEMENT</Text>
        {/* <Text style={styles.author}>/Text> */}
       
            <Text style={styles.subtitle}>
                <Text style={{marginLeft:'10px', fontSize:'12px'}}>THIS TECHNOLOGY SERVICES AGREEMENT</Text>
        (the "Agreement") effective{" "}{moment(props?.form_fields?.creationDate).format("MMMM D, YYYY ")}{" "} is made and
                ...
                {!props?.vendors ? '' : props?.vendors[0].company_name
.toUpperCase()} at{" "} {!props?.vendors ? '' : props?.vendors[0].street.toUpperCase() + ', ' + props?.vendors[0].city.toUpperCase() + ', ' + props?.vendors[0].state.toUpperCase() + ', ' + props?.vendors[0].zip_code.toUpperCase()} (“Contractor”).
        </Text>
