		...
		<div style={{ margin: "1in", pageBreakAfter: "always" }}>
			...
			<div className="mb-2 flex ml-9 pl-4">
				...
				<span className="ml-2 text-justify">
					...
					services will perform substantially in conformance with the agreed
					upon DPS specifications. In the event any non-conformance cannot be
					corrected within seven days, DPS shall be entitled to a refund for
