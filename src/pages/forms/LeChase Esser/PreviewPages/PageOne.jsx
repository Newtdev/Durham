...
const PageOne = ({ form_fields, content, nottoBeHighlighted, awardee }) => {
	return (
		<div
				...
				<div>
					...
					<div className="flex">
						...
						<div className=" ml-7">
							...
							<div className="mt-2">
								{/* 1.1 */}
								<div className="mb-2">
									<span className="pr-6 underline underline-offset-2">
										1.1.
									</span>
								...
								<div className="ml-[62px]">
									<div className="mb-2 flex">
										...
										<p className="text-justify">
											...
											laws and regulations regarding the use of ESSER funds by
											the School System;
										</p>
									</div>
									<div className="mb-2 flex">
									...
									<div className="mb-2 flex">
										...
										<p className="text-justify">
											Ensure the School System’s compliance with the use of
											ESSER funds;
										</p>
									</div>
									<div className="mb-2 flex">
										...
										<p className="text-justify">
											Maintain all records associated with the use of ESSER
											funds, including preparing and submitting any required
											reports associated with the use of ESSER; and
										</p>
									</div>
									<div className="mb-2 flex">
							...
							{/* 1.2 */}
							<div className="mt-2 mb-2 text-justify flex">
								<span className=" inline-block underline underline-offset-2">
									1.2.
								</span>
								<p className="pl-4">
									<span className=" mr-2 inline-block  underline underline-offset-2">
										Qualifications of Provider.
									</span>
									<span className="">
										Provider warrants that all agents or employees of Provider
										who will provide services under this Contract will be fully
							...
							{/* 1.3 */}
							<div className="mt-2 mb-2 text-justify flex">
								<span className=" underline underline-offset-2">1.3.</span>
								<p className="pl-4">
					...
					<div className="flex mb-2">
						...
						<div className=" ml-7">
							...
							{/* 2.1 */}
							<div className="mt-2 text-justify flex">
								<span className="pr-4">2.1.</span>
								<span className="inline-block ">
									The School System hereby agrees to compensate Provider at a
									rate or in the amount of{" "}
									<span className={`${nottoBeHighlighted}`}>
										{!form_fields
											? ""
			...
			<div className="w-full flex justify-center  Times-font">
				<p>1</p>
			</div>
		</div>
	);
