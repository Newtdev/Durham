const PageFourteen = ({ formDetails, vendor, nottoBeHighlighted }) => {
	return (
		<div className="pt-6 pb-4 text-black text-[12pt] h-[11in] ">
			<div>
				{/* Page 14 */}
				<div className="m-[1in]">
						...
						<div>
								...
								<div>
									...
									<div className="flex gap-4 items-center">
										<input
											...
											id="initial"
											checked={
												formDetails?.checkType === "Annual" ? true : false
											}
											className="h-2 w-2"
										/>
							...
							<div className=" w-full">
								<p className="mb-4 text-justify">
									...
									this Agreement for all contractual personnel (employees,
									agents, ownership personnel, or contractors ) who may be used
									to deliver goods or provide services under this Agreement,
									including the North Carolina Sex Offender and Public
									Protection Registration Program, the North Carolina Sexually
									Violent Predator Registration Program, and the National Sex
									Offender Registry. I further certify that none of the
									individuals listed below appears on any of the above-named
									registries and that I will not assign any individual to
							...
							<div>
								...
								<div className="flex gap-x-24">
									...
									<div>
										<p className="mb-4 ">
											<span
												className={`${nottoBeHighlighted} inline-block w-48 border-b border-black`}></span>
											{/* <span className="pt-1">___________</span> */}
											{"    "}
											<span>(signature)</span>
										</p>
