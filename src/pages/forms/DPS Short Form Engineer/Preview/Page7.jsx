...
const PageSeven = () => {
	return (
		...
		<DPSPageWrapper num={7}>
			<div className="">
				<div className="ml-[64px] mb-4">
					<p className="text-justify">
						their fault or negligence, including but not limited to, any of the
						following events or occurrences: fire, flood, earthquake, epidemic,
						atmospheric condition of unusual severity, war, state or local
						government acting in its sovereign capacity, and strikes. Owner
						shall not be liable to the Engineer for acts or failures to act by
						the Contractor or the Owner's consultants.
					</p>
				</div>
				...
				<div className="flex gap-12 mb-4">
					...
					<p className="text-justify">
						...
						Justice Sex Offender Public Website at <i>http://www.nsopw.gov/.</i>{" "}
				...
				<div className="flex gap-12 mb-4">
					...
					<p className="text-justify">
						...
						joint venture; nor shall any employee of Engineer be construed as an
				...
				<div className="flex gap-12">
					...
					<p className="text-justify">
						...
						Owner who are not authorized by federal law to
					</p>
				</div>
			</div>
		</DPSPageWrapper>
