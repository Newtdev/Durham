...
const PageTwo = ({ formsDetails, vendor, nottoBeHighlighted }) => {
	return (
		<div className="pt-8 pb-4 text-black h-[11in] text-[10pt]">
			<div>
				{/* Page 2 */}
				<div className="m-[1in]">
					...
					<p className="text-justify mb-8">
						...
						in the Proposal and Scope of Services attached to this Agreement as
						Exhibit A.
					</p>
					...
					<div className="text-[10pt]">
						...
						<div>
							<div className="flex gap-8 mb-4">
								<p>1.1</p>
								<p>
									<span className="mr-3">WORK:</span> The Engineer shall perform
									the services outlined on the attached Exhibit A as authorized
									by the Owner and in accordance with the terms and conditions
									of this Agreement. The Engineer agrees that all plans,
									drawing, specifications, designs and surveys in draft or final
									form are the property of the Owner, who may demand possession
									of them at anytime from Engineer and receive the same within
							...
							<div className="flex gap-8 mb-4">
								...
								<div>
									...
									<p>
										...
										Engineer’s compliance with the schedule, the Engineer shall
							...
							<div className="flex gap-8 mb-4">
								<p>1.3</p>
								<p>
									<span className="mr-3">COMPENSATION:</span> The Engineer shall
									be compensated in accordance with the fee schedule included in
									Exhibit A to this Agreement and this Paragraph. The fee
									described in Exhibit A shall cover the cost of the engineering
									services (including the furnishing of all materials,
									apparatus, labor and any required insurance). Attached as
									Exhibit B is an hourly rate schedule for any services to be
									provided by the hour and any additional services that may be
									authorized under this Agreement. The Engineer shall not be
									compensated for any work or services performed without
									specific authorization from Owner.
								</p>
							</div>
							...
							<div className="flex gap-[35px] mb-4">
								...
								<div>
									...
									<div className="ml-10">
										...
										<p className="border-b border-black w-48">
											<span className={`${nottoBeHighlighted}`}>
												{`${formsDetails?.city}, ${formsDetails?.state}, ${formsDetails?.zipCode}`}
											</span>
										</p>
									</div>
								</div>
							...
							<div className="flex gap-12 mb-4">
								...
								<div>
									...
									<p className="mb-1 text-justify">
										...
										Engineer's employees or any other person; claims for damages
