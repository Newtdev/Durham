				...
				<div className=" ml-7">
					<p className="text-justify">
						...
						<span className="ml-1">
							...
							<a href="http://www.nsopw.gov/">http://www.nsopw.gov/</a>.
							Provider shall provide certification on the Sexual Offender
							Registry Check Certification Form (Exhibit B) that the registry
							checks were conducted on each of its Contractual Personnel
							providing services or delivering goods under this Contract prior
							to the commencement of such services or the delivery of such
							goods. Provider shall conduct a current initial check of the
							registries. The sex offender registry checks shall be conducted
							within 30 days of Provider’s execution of the Contract and prior
							to performing any services on School System property. In addition,
							Provider agrees to conduct the registry checks and provide a
							supplemental certification form before any additional Contractual
							Personnel are used to deliver goods or provide services pursuant
							to this Contract. Provider further agrees to conduct annual
