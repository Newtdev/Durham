...
const Page1 = (props) => {
  return (
    ...
    >
      <p class={`${s.c3} ${s.c311}`}>
        <span class={`${s.c81} ${s.c80} ${s.c148} ${s.c98} ${s.c96}`}>
          Bidder:{" "}
          <span class={`border-b-2 border-black ${props?.nottoBeHighlighted}`}>
            {props?.form_fields?.bidderName}
          </span>
        </span>
      </p>
      <p class={s.c129}>
        <span class={s.c37}>Durham Public Schools</span>
      </p>
      <p class={`${s.c129} ${s.c12}`}>
      ...
      <table class={s.c252}>
        <tr class={s.c306}>
          <td class={s.c13} colspan="1" rowspan="1">
            <p class="c3">
              <span class={s.c88}>&nbsp;</span>
              <span class={`${s.c92} ${s.c81} ${s.c80}`}>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Durham
                Public Schools
              </span>
            </p>
            <p class={`${s.c3} ${s.c12}`}>
              <span class={`${s.c92} ${s.c81} ${s.c80}`}></span>
            </p>
            <p class={s.c182}>
              {/* <span class="c68 c89">RFP# 179-2122-621-LF-SOLAR</span> */}
              <span class={`${s.c89} ${props?.nottoBeHighlighted}`}>
            ...
            <p class={s.c163}>
              ...
              <span
                class={`${s.c81} ${s.c80} ${s.c92} ${props?.nottoBeHighlighted}`}
              >
