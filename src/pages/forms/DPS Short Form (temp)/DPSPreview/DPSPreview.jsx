              ...
              <div className='bg-[#D9D9D9] px-12 pt-8 pb-4 text-black'>
                ...
                <div className='text-start'>
                  <p>
                    ...
                    <span className='bg-yellow-500'>F3</span> for furnishing of
                    labor, material and equipment for the{" "}
                    <span className='bg-yellow-500'>F4</span>. Bids will be
                    received up to <span className='bg-yellow-500'>F5</span>{" "}
                ...
                <div className='mt-5'>
                  ...
                  <div className='mb-5'>
                    <p>
                      ...
                      Scheduled for <span className='bg-yellow-500'>F8</span>{" "}
                      <span className='bg-yellow-500'> F9 </span>{" "}
                      <span className='bg-yellow-500'> F10 </span>{" "}
                      <span className='bg-yellow-500'> F11 </span> Inspection of
                      all sites shall be scheduled immediately after the Pre-Bid
                      Conference. The design team and owner will provide access
                      to the necessary location. The project Designer or
                      Designer’s representative will be available to answer
                      questions.
                    </p>
                  </div>
                  <div className='mb-5'>
