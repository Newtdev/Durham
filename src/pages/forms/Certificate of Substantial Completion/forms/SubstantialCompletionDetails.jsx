...
const dispatch  = useDispatch()
    const areasCompleted = {
        ...
        name: 'areasCompleted',
        type: 'text',
        placeholder: 'Enter the project or the area deemed to be substantially complete'
    }
        ...
        <form onSubmit={props.handleSubmit} className='relative w-[600px] bg-white rounded-lg shadow py-4'>
            ...
            <div className='mx-6 mb-12'>
                <div className='flex flex-col mb-5'>
                    ...
                    >
                        Enter the project or the area that has been deemed to be substantially complete.
                    </label>
                    <FormInputPlain  {...areasCompleted} />
                    {props.errors.areasCompleted && props.touched.areasCompleted && <Error message={props.errors.areasCompleted} />}
                ...
                <div className='flex flex-col mb-5'>
                    ...
                    {props.errors.workCompletionDate && props.touched.workCompletionDate && <Error message={props.errors.workCompletionDate} />}
                ...
                <div className='flex flex-col mb-5'>
                            ...
                            {props.errors.costOfWork && props.touched.costOfWork && <Error message={props.errors.costOfWork}/>}
