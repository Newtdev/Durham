				...
				<form
					...
					<div className="mx-6 mb-12">
						<div className="flex flex-col mb-5">
							...
							{props.errors.purposeOfContract &&
								props.touched.purposeOfContract && (
									<Error message={props.errors.purposeOfContract} />
								)}
						</div>

						<FormInputContainer name="When did the contract go into effect?">
							<SelectDate {...contractEffectDate} />
							{props.errors.contractEffectDate &&
								props.touched.contractEffectDate && (
									<Error message={props.errors.contractEffectDate} />
								)}
						</FormInputContainer>

						<div className="flex flex-col mb-5">
							<label className="text-base text-gray-900 mb-1">
								Other than the owner, the architect, and the contractor, who
								else is involved in this project?
							</label>
							<FormInputPlain {...involvedInProject} />
							{props.errors.involvedInProject &&
								props.touched.involvedInProject && (
									<Error message={props.errors.involvedInProject} />
								)}
						</div>
					</div>
					{/* Buttons */}
