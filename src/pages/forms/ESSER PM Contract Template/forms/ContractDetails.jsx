...
const ContractDetails = (props) => {
    ...
    useEffect(() => {
        ...
        // console.log(response?.data?.data?.form_fields.providerInvoice)s
        ...
        <form className='relative w-[600px] bg-white rounded-lg shadow py-4' onSubmit={props.handleSubmit}>
            ...
            <div className="px-4">
                <FormInputContainer name="What day is the contract formally made and entered into?">
                    ...
                    {props.errors.contractStartDate && props.touched.contractStartDate && <Error message={props.errors.contractStartDate} />}
                </FormInputContainer>
                ...
                <div className='grid grid-cols-2 gap-x-4 content-center'>
                    ...
                    <div className="flex justify-between">
                        {props.errors.startDuration && props.touched.startDuration && <Error message={props.errors.startDuration} />}
                        {props.errors.fromDuration && props.touched.fromDuration && <Error message={props.errors.fromDuration} />}
