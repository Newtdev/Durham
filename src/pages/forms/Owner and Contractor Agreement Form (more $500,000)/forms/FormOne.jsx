				...
				<div className='mx-6 mb-12'>
					<div className='mt-3 ml-2 flex flex-col gap-3 '>
						...
						<FormInputContainer name="What precisely is the new construction in this project?">
							<FormInputPlain type={"text"} onChange={props.handleChange} name='construction' placeholder="Hereinafter referred to as the 'Project' or 'Work'" />
							{props.errors.construction && props.touched.construction && <Error message={props.errors.construction} />}
						</FormInputContainer>
						...
						<FormInputContainer name='Enter the date of completion for the following.'>
							<div className="flex gap-3">
								...
								<div className="w-full">
									...
									{props.errors.finalCompletionDate && props.touched.finalCompletionDate && <Error message={props.errors.finalCompletionDate} />}
								</div>
							</div>
						</FormInputContainer>
					</div>
