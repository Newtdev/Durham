				...
				<div className='mx-6 mb-12'>
					<div className='mt-3 ml-2 flex flex-col gap-3 '>
						<FormInputContainer name="What is the Contract Amount?">
							<FormInput type={"number"} onChange={props.handleChange} name='contractAmount' placeholder="0.0" />
						...
						<FormInputContainer name="Enter the allowances that are included in the contract sum, if applicable.">
							<FormInputPlain type={"text"} onChange={props.handleChange} name='allowances' placeholder="Allowances" />
							{props.errors.allowances && props.touched.allowances && <Error message={props.errors.allowances} />}
						</FormInputContainer>
									...
									<>
										<div className="mt-5">
											{props?.values?.units.map((unit, index) => (
												<Fragment key={index}>
													<FormInputContainer name={`unit ${index}`}>
														<FormInput type={"number"} onChange={props.handleChange} name={`units[${index}].unit`} placeholder="0.0" />
													</FormInputContainer>
												</Fragment>
											))}
											<div className="mt-4">
