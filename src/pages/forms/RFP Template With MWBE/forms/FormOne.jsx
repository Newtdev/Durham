				...
				<div className='mx-6 mb-12'>
					...
					<div className='mt-3 ml-2 '>
						...
						<FormInputContainer name="Enter the Bidder's Name.">
							<FormInputPlain type={"text"} onChange={props.handleChange} name="bidderName" placeholder={"Name"} />
							{props.errors.bidderName && props.touched.bidderName && <Error message={props.errors.bidderName} />}
						</FormInputContainer>

						<FormInputContainer name='Enter the RFP Number'>
							<FormInputPlain type={"text"} onChange={props.handleChange} name="rfpNumber" placeholder={"Number"} />
							{props.errors.rfpNumber && props.touched.rfpNumber && <Error message={props.errors.rfpNumber} />}
						</FormInputContainer>

						<FormInputContainer name="Enter the person's name for the 'ATTN' field.">
							<FormInputPlain type={"text"} onChange={props.handleChange} name="personName" placeholder={"Name"} />
							{props.errors.personName && props.touched.personName && <Error message={props.errors.personName} />}
						</FormInputContainer>

						<FormInputContainer name='Enter the contract type.'>
							<FormInputPlain type={"text"} onChange={props.handleChange} name="contractType" placeholder={"Contract type"} />
