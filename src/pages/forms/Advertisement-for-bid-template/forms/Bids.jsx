				...
				<div className="px-4">
					...
					<div className="grid grid-cols-2 gap-x-4">
						<FormInputContainer name="Bid Deadline Time">
							...
							{props.errors.deadlineTime && props.touched.deadlineTime && (
								<Error message={props.errors.deadlineTime} />
							)}
						</FormInputContainer>
						<FormInputContainer name="Bid Opening Time">
							<SelectTime {...openingTime} />
							{props.errors.openingTime && props.touched.openingTime && (
								<Error message={props.errors.openingTime} />
							)}
						</FormInputContainer>
					</div>
					...
					<div className="flex flex-col mb-5">
						...
						/>
						{props.errors.withdrawingBid && props.touched.withdrawingBid && (
							<Error message={props.errors.withdrawingBid} />
						)}
					</div>
				</div>
				{/* Buttons */}
