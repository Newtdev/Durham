				...
				<div className="px-4">
					<div className="flex flex-col mb-5">
						...
						{props.errors.company_name && props.touched.company_name && (
							<Error message={props.errors.company_name} />
						)}
					</div>
					<div className="flex flex-col mb-5">
						<label
						...
						<input
							...
							className="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-sm hover:outline-[#3B6979] hover:border-[#3B6979] w-full p-2 flex items-center "
						/>
						{props.errors.manager_name && props.touched.manager_name && (
							<Error message={props.errors.manager_name} />
						)}
					</div>
					<div className="flex flex-col mb-5">
						<label
						...
						<input
							...
							className="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-sm hover:outline-[#3B6979] hover:border-[#3B6979] w-full p-2 flex items-center "
						/>
						{props.errors.manager_phone_number &&
							props.touched.manager_phone_number && (
								<Error message={props.errors.manager_phone_number} />
							)}
					</div>
					<div className="flex flex-col mb-5">
						<label
						...
						<input
							...
							className="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-sm hover:outline-[#3B6979] hover:border-[#3B6979] w-full p-2 flex items-center "
						/>
						{props.errors.manager_email_address &&
							props.touched.manager_email_address && (
								<Error message={props.errors.manager_email_address} />
							)}
					</div>
				</div>
