...
const PageTwo = ({ form_fields, nottoBeHighlighted, project }) => {
	return (
		<div className="text-[11pt] arial-font leading-[1.2] pt-[1in] h-[11in]   ">
				...
				<div className={``}>
					...
					<div className="mb-3 mt-6">
						<p>
							...
							<span className={` ${nottoBeHighlighted}`}>
								{doConvert(form_fields?.projects)}
							</span>{" "}
							<span className={` ${nottoBeHighlighted}`}>
								({form_fields?.projects})
							</span>{" "}
							projects of scope within the past{" "}
							<span className={` ${nottoBeHighlighted}`}>
								{doConvert(form_fields?.years)}
							</span>{" "}
							<span className={` ${nottoBeHighlighted}`}>
								({form_fields?.years})
							</span>{" "}
					...
					<div className="mb-3 ">
						<p>
							...
							Each proposal shall be accompanied by a statement of ability to
							staff including current project load, current staff levels and
							individual staff to be committed to this project if awarded.
						</p>
					</div>
					<p>
						<em>
							...
							<div className="h-full flex flex-col justify-between ">
								...
								<div className="text-start">
									<p className="">
										...
										<span className={`  ${nottoBeHighlighted}`}>
											{moment(form_fields?.bidDate).format(
												"dddd, MMMM D, YYYY"
											)}
										</span>{" "}
								...
								<div className="mt-4">
									...
									<div className="mb-3 ">
										<p>
											...
											<span className={`  ${nottoBeHighlighted}`}>
												{trucateText(form_fields?.projectScope, 50)}
											</span>
										</p>
									</div>
									<div className=" ">
