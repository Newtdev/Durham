...
export const FormInputContainer = ({ name, children }) => {
	return (
		<div className="flex flex-col mb-3">
			<label for="default-radio-1" className="text-sm text-gray-600 font-semibold mb-1">
				{name}
			</label>
			{children}
		</div>
					...
					<div className="mx-6 mb-12">
						...
						<div className=" mt-3 ml-2">
							...
							<div className="flex flex-col mb-5">
								...
								{props.errors.projectAmount && props.touched.projectAmount && (
									<Error message={props.errors.projectAmount} />
								)}
							</div>

							{/* </FormInputContainer> */}

							{props.values.approval === "Yes" && (
