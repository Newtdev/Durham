			...
			<form className='relative w-[600px] bg-white rounded-lg shadow py-4' onSubmit={props.handleSubmit}>
				...
				<div className='mx-6 mb-12'>
					<div className='mt-3 ml-2 flex flex-col gap-3 '>
						<FormInputContainer name="Enter the Design, Construction, and Equipment Budget.">
							<FormInput type={"number"} onChange={props.handleChange} value={props?.values?.ccap} name='ccap' placeholder="CCAP" />
							{props.errors.ccap && props.touched.ccap && <Error message={props.errors.ccap} />}
						</FormInputContainer>
						...
						<FormInputContainer name="Based on the date of the bid, enter the owner's deadline for ordering drawings and specifications.">
							...
							{props.errors.ownerDeadline && props.touched.ownerDeadline && <Error message={props.errors.ownerDeadline} />}
						</FormInputContainer>

						<FormInputContainer name="Enter the percentage of the said price for the in-progress contingency fund.">
							<FormInputPlain type={"number"} value={props?.values?.percentage} onChange={props.handleChange} name='percentage' placeholder="Percentage" />
