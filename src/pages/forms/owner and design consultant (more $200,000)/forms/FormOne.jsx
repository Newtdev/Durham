			...
			<form className='relative w-[600px] bg-white rounded-lg shadow py-4' onSubmit={props.handleSubmit}>
				...
				<div className='mx-6 mb-12'>
					<div className='mt-3 ml-2 flex flex-col gap-3 '>
						...
						<div classNAme="">
							<FormTextArea type={"text"} onChange={props.handleChange} value={props?.values?.projectObjective} name="Enter the project's objectives" id='projectObjective' placeholder="Project Objectives" />
							{props.errors.projectObjective && props.touched.projectObjective && <Error message={props.errors.projectObjective} />}
						</div>
						...
						<div className="p-2 flex flex-col gap-2">
							...
							{props.errors.newSchool && props.touched.newSchool && <Error message={props.errors.newSchool} />}
						</div>

						<FormInputContainer name="School Name">
							<FormInputPlain type={"text"} onChange={props.handleChange} value={props?.values?.schoolName} name='schoolName' placeholder="Enter School Name" />
							{props.errors.schoolName && props.touched.schoolName && <Error message={props.errors.schoolName} />}
						</FormInputContainer>

						<FormInputContainer name="How many Students have enrolled in the School?">
							<FormInputPlain type={"number"} onChange={props.handleChange} name='studentNumber' value={props?.values?.studentNumber} placeholder="Input Text" />
							{props.errors.studentNumber && props.touched.studentNumber && <Error message={props.errors.studentNumber} />}
						</FormInputContainer>

						<FormInputContainer name="Approximate maximum square footage for the facility">
							<FormInputPlain type={"text"} onChange={props.handleChange} name='squareFootage' value={props?.values?.squareFootage} placeholder="Square Feet" />
							{props.errors.squareFootage && props.touched.squareFootage && <Error message={props.errors.squareFootage} />}
						</FormInputContainer>

						<FormInputContainer name="The school designed can accomodate students upto">
							<FormInputPlain type={"text"} onChange={props.handleChange} value={props?.values?.accomodateNumber} name='accomodateNumber' placeholder="Input Text" />
							{props.errors.accomodateNumber && props.touched.accomodateNumber && <Error message={props.errors.accomodateNumber} />}
						</FormInputContainer>

						<FormInputContainer name='Where is the school built?'>
							<div className="flex flex-col">
								<FormInputPlain type={"text"} onChange={props.handleChange} value={props?.values?.street} name="street" placeholder={"Street"} />
