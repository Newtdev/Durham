...
import { closeModal, fields, fields } from "../../../reducer";
					...
					<div className="mx-6 mb-12">
						<div className=" mt-3 ml-2">
							...
							<div className="mb-6">
								...
								{props.errors.CMContingency && props.touched.CMContingency && (
									<Error message={props.errors.CMContingency} />
								)}
							</div>
							<div className="mb-6">
								<p className="text-gray-900 font-medium text-sm mb-[2px]">
								...
								{props.errors.generalConditions &&
									props.touched.generalConditions && (
										<Error message={props.errors.generalConditions} />
									)}
							</div>
							<div className="mb-6">
								<p className="text-gray-900 font-medium text-sm mb-[2px]">
								...
								{props.errors.fees && props.touched.fees && (
									<Error message={props.errors.fees} />
								)}
							</div>
							<div className="mb-6">
								<p className="text-gray-900 font-medium text-sm mb-[2px]">
								...
								{props.errors.preConstruction &&
									props.touched.preConstruction && (
										<Error message={props.errors.preConstruction} />
									)}
							</div>
						</div>
					</div>
