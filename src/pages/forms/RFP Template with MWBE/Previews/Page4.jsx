      ...
      <>
        ...
        <p class="c27">
          <span class="c30">
            ...
            constitute grounds for rejection of said Vendor&rsquo;s offer, at
            the State&rsquo;s election.
          </span>
        </p>
        ...
        <p class="c208">
          <span class="c21">
            Sealed proposals, subject to the conditions made a part hereof and
            the receipt requirements described below, shall be received at the
            address indicated in the table below, for furnishing and delivering
        ...
        <p class="c23 c277">
          ...
          <span class="c22">
            ...
            proposal deadline in order to be considered timely, regardless of
            the method of delivery.{" "}
          </span>
          <span class="c10">This is an absolute requirement.</span>
          <span class="c22">
            &nbsp; All risk of late arrival due to unanticipated
            delay&mdash;whether delivered by hand, U.S. Postal Service, courier
            or other delivery service is entirely on the Vendor.{" "}
          </span>
          <span class="c22 c130">
          ...
          <span class="c21">
            . The time of delivery will be marked on each proposal when
            received, and any proposal received after the proposal submission
            deadline will be rejected. Sealed proposals, subject to the
            conditions made a part hereof, will be received at the address
            indicated in the table in this Section, for furnishing and
            delivering the commodity as described herein.
          </span>
        </p>
        <p class="c23 c109">
          <span class="c22">
          ...
          <span class="c22">
            &nbsp;be delivered to the agency&rsquo;s purchasing office on the
            due date in time to meet the proposal deadline. All Vendors are
            urged to take the possibility of delay into account when submitting
            a proposal.
          </span>
