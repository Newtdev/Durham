...
const Page4 = () => {
  return (
    <div style={{ margin: "1in", paddingTop: "6rem", height: "10in" }}>
      <p class="p0">
        <span class="p4">ARTICLE</span>
        <span class="p7">&nbsp;2</span>
      </p>
      <p class="p0">
        <span class="p1">BASIC SERVICES</span>
      </p>
      <ol class="ppg flex items-start" start="2">
        <span className="mr-11">1.2</span>
        <li class="pli ">
          <span class="p4 underline">Scope of Services.</span>
        </li>
      </ol>
      <p class="p9 p12 p57">
        <span class="p1"></span>
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.1.1</span>
        <li class="pli ">
          <span class="p4">
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.1.2</span>
        <li class="pli ">
          <span class="p4 ">
            It is the responsibility of the Engineer to ensure that the
            Project&rsquo;s Construction Documents require that no
            asbestos-containing materials are to be incorporated in the Project.
          </span>
        </li>
      </ol>
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.2.1</span>
        <li class="pli ">
          <span class="p4 ">
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.2.2</span>
        <li class="pli ">
          <span class="p4 ">
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.2.3</span>
        <li class="pli ">
          <span class="p4 ">
            ...
            drawings, specifications and other documents prepared by the
            Engineer. &nbsp;The Engineer further agrees, at no additional cost,
            to render assistance to the Owner in resolving problems relating to
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.2.4</span>
        <li class="pli ">
          <span class="p4 ">
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.2.5</span>
        <li class="pli ">
          <span class="p4 ">
            ...
            requested. &nbsp;Participants shall be as determined by the Owner.
          </span>
        </li>
      </ol>
      ...
      <ol class="ppg flex items-start" start="2">
        <span className="mr-8">2.2.6</span>
        <li class="pli ">
          <span class="p4 ">
      ...
      <ol class="ppg flex items-start" start="2">
        ...
        <li class="pli ">
          <span class="p4 ">
            ...
            herewith, in my/our professional opinion, fulfill the Scope of Work
            and are in accordance with the requirements of all regulation
            agencies.&quot;
          </span>
        </li>
      </ol>
