...
import DpsFormalGeneral from "../../forms/DPS Formal General/DpsFormalGeneral";
import { ProposalForm } from "../../forms/Budget/Change-Proposal-Form 2";
import BidManual from "../../forms/Bid-manual/BidManual";
import {
	lundsford,
	...
	DPSFormalGeneralSlug,
	ContractPreparationForm,
	BidManualSlug,
...
const ProjectDashboard = () => {
	...
	return (
		<section>
							...
							<button
								onClick={() => {
									...
									navigate("/dashboard/edit-project", {
										state: response?.currentData?.data?.id || null,
									});
								}}
								type="button"
			...
			{documentsID === ContractPreparationForm ? (
				<ContractPreparationCheckList id={documentsID} filled={filled} />
			) : null}
			{documentsID === DPSFormalGeneralSlug ? (
				<DpsFormalGeneral id={documentsID} filled={filled} />
			) : null}
			{documentsID === BidManualSlug ? (
				<BidManual id={documentsID} filled={filled} />
			) : null}
		</section>
	);
};
