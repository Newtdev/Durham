  ...
  return (
    <section className=''>
      ...
      <main className='pt-6 bg-[#fafafa]'>
        <div className='container mx-auto px-4 lg:px-24'>
          <div className='flex gap-4 flex-col md:flex-row md:justify-between items-center'>
            ...
            <DashboardButton name='ADD NEW USERS' width='w-[211px]' />
          </div>
          ...
          <div className='overflow-x-auto relative shadow rounded-lg border-solid border border-gray-100 '>
            <table className='w-full text-sm text-left text-gray-900'>
              <TableHeader dataArray={UsersHeader} />
              <UsersTableBody dataArray={UsersContent} />
            </table>
          </div>
          {/* PAGINATION */}
          <Pagination />
        ...
        <div>
          ...
          <div className='relative w-full max-w-md h-screen md:h-auto mx-auto mt-14 bg-white rounded-lg shadow pb-4'>
            ...
            <div className='mt-12 mr-5 flex gap-4 justify-end'>
              ...
              <Button name='yes, edit' width='w-[111px]' />
            </div>
          </div>
        </div>
      </ModalOverlay>
      ...
      <article>
        ...
        >
          <div className='relative w-full max-w-md h-screen md:h-auto mx-auto mt-2'>
            <DeletePopup text='User infromation deleted successfully' />
          </div>
        </div>
      </article>
    </section>
