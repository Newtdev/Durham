...
import { AuthHeader, InputContainer } from "../component";
			...
			<div
				...
				<div className="h-full w-full flex flex-col justify-evenly items-center">
					...
					<p className="text-center text-sm text-gray-500">
						We sent a link to {values.email}
					</p>
					<p className="text-center text-sm text-gray-500">
						Follow the link in the email to reset your password . If you did not
						receive the email, kindly check your spam or you can resend the
						email.
					</p>
					<button className="text-[#3B6979] text-base  w-[360px]focus:ring-4 hover:bg-[#3B6979] transition-all focus:outline-none focus:ring-blue-300 hover:bg-transparent border border-[#3B6979] hover:text-white font-bold rounded-md px-5 py-3 text-center">
						Resend Email
					</button>
				</div>
			</div>
